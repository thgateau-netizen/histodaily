...
function handleHealth(req, res) {
  return send(res, 200, {
    ...
    features: ['daily-mystery', 'course-flow', 'leaderboards', 'friends', 'friend-requests', 'public-profiles', 'profile-lookup', 'request-badges', 'local-backup', 'pwa', 'offline-score-outbox', 'identity-mirror']
  });
}
