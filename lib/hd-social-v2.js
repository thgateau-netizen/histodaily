...
async function leaderboardRows({ period, audience, identity, query }) {
  ...
  const rows = aggregateScores(scores || [], profiles || [], includeIds, seedPlayers);
...
module.exports = {
  VERSION,
  handleSocialV2,
  _test: { cleanCode, cleanId, periodBounds, aggregateScores, limitRowsPreservingIds, friendRows, leaderboardRows, scoreCap, scoreFloor, canonicalMysteryScore, validRecentPeriodKey, canonicalSolvedAt, profilePayload, upsertBestScore }
};
