...
- version `1.0.0-beta.265.0` cohérente entre client, serveur, manifeste et cache ;
...
- en-tête serveur `X-HistoDaily-Social-Version: 1.0.0-beta.265.0` sur chaque route.
...
- le moteur quotidien annonce la version `1.0.0-beta.265.0`.
