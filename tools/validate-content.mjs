...
const versionOk = ['app-core.js','index.html','service-worker.js','api/v1/health.js'].every(file => fs.readFileSync(file,'utf8').includes('1.0.0-beta.57'));
if (!versionOk) issues.push('Version beta56 absente dans au moins un fichier critique');
...
console.log('Audit contenu OK — beta56 social-ready');
