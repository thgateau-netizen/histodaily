...
5. Fermer complètement la PWA puis la rouvrir. Le cache attendu est `histodaily-beta265-v1`.
...
- `/api/v1/social-v2/health` doit répondre avec `ok: true`, `version: "1.0.0-beta.265.0"` et `architecture: "single-social-engine-v2"`.
