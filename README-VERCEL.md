# Déployer HistoDaily 1.0.0-beta.176 sur Vercel
...
6. Effectuer une actualisation forcée. Pour une PWA installée, la fermer complètement puis la rouvrir afin d’activer le cache `beta176`.
...
- Ouvrir `/api/v1/health` : la réponse doit indiquer la version `1.0.0-beta.176`.
