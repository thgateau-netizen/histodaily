...
5. Fermer complètement la PWA puis la rouvrir. Le cache attendu est `histodaily-beta262-v1`.
...
- `/api/v1/social-v2/health` doit répondre avec `ok: true`, `version: "1.0.0-beta.262.0"` et `architecture: "single-social-engine-v2"`.
