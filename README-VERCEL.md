...
5. Fermer complètement la PWA puis la rouvrir. Le cache attendu est `histodaily-beta266-v1`.
...
- `/api/v1/social-v2/health` doit répondre avec `ok: true`, `version: "1.0.0-beta.266.0"` et `architecture: "single-social-engine-v2"`.
