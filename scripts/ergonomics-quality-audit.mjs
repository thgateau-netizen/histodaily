...
pass('rc48BuildManifestIsGenerated', build.includes("'RC48-BUNDLE-MANIFEST.json'") && build.includes("uiPass: 'RC48 Discipline Sync'"), 'Les outils de release doivent décrire la version réellement livrée.');
...
fs.writeFileSync(path.join(root, 'RC48-ERGONOMICS-QUALITY-AUDIT.json'), JSON.stringify(result, null, 2) + '\n');
