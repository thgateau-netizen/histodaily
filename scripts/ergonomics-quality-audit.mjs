...
pass('rc49BuildManifestIsGenerated', build.includes("'RC49-BUNDLE-MANIFEST.json'") && build.includes("uiPass: 'RC49 Flow & English Clarity'"), 'Les outils de release doivent décrire la version réellement livrée.');
