...
pass('rc50BuildManifestIsGenerated', build.includes("'RC50-BUNDLE-MANIFEST.json'") && build.includes("uiPass: 'RC50 English Useful Packs'"), 'Les outils de release doivent décrire la version réellement livrée.');
