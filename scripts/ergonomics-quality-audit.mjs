...
pass('rc52BuildManifestIsGenerated', build.includes("'RC54-BUNDLE-MANIFEST.json'") && build.includes("uiPass: 'RC54 Central Retention Analytics'"), 'Les outils de release doivent décrire la version réellement livrée.');
...
fs.writeFileSync(path.join(root, 'RC49-ERGONOMICS-QUALITY-AUDIT.json'), JSON.stringify(result, null, 2) + '\n');
