...
- version active harmonisée en `1.0.0-beta.265.0` dans l’application, le manifeste, le service worker et les réponses serveur ;
- cache PWA isolé sous `histodaily-beta265-v1` ;
