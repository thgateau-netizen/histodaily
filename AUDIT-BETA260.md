...
- version active harmonisée en `1.0.0-beta.266.0` dans l’application, le manifeste, le service worker et les réponses serveur ;
- cache PWA isolé sous `histodaily-beta266-v1` ;
