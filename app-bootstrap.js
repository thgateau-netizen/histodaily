...
window.HISTODAILY_CORE = {
  version: "1.0.0-beta.246.0",
  assetsVersion: "1.0.0-beta.246.0",
  ...
  ui: {
    versionLabel: "beta 246",
    shareBaseUrl: "https://histodaily.vercel.app",
    releaseNotes: [
      "Amis robustes : une relation supprimée ne peut plus réapparaître après actualisation.",
      "Actions sociales hors ligne : acceptations, refus et suppressions sont conservés puis rejoués dans le bon ordre.",
      "Classements Amis cohérents : jour, semaine et année sont recalculés après chaque changement de relation."
    ]
  },
