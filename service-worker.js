const CACHE_NAME = "histodaily-beta213-v1";
const APP_VERSION = "1.0.0-beta.213.0";
const ASSETS = [
  "/",
  "/index.html",
  "/app.css?v=1.0.0-beta.213.0",
  "/lessons-lite.js?v=1.0.0-beta.213.0",
  "/app-bootstrap.js?v=1.0.0-beta.213.0",
  "/app.js?v=1.0.0-beta.213.0",
  "/content-library.js?v=1.0.0-beta.213.0",
  "/app-runtime.js?v=1.0.0-beta.213.0",
