const CACHE_NAME = "histodaily-beta255-v1";
const APP_VERSION = "1.0.0-beta.255.0";
const ASSETS = [
  "/",
  "/index.html",
  "/app.css?v=1.0.0-beta.255.0",
  "/mobile-layout.css?v=1.0.0-beta.255.0",
  "/social-v2.css?v=1.0.0-beta.255.0",
  "/lessons-lite.js?v=1.0.0-beta.255.0",
  "/app-bootstrap.js?v=1.0.0-beta.255.0",
  "/app.js?v=1.0.0-beta.255.0",
  "/content-library.js?v=1.0.0-beta.255.0",
  "/content-literature.js?v=1.0.0-beta.255.0",
  "/content-premium-233.js?v=1.0.0-beta.255.0",
  "/content-premium-234.js?v=1.0.0-beta.255.0",
  "/content-premium-235.js?v=1.0.0-beta.255.0",
  "/content-premium-236.js?v=1.0.0-beta.255.0",
  "/content-premium-237.js?v=1.0.0-beta.255.0",
  "/content-coherence-239.js?v=1.0.0-beta.255.0",
  "/content-humanize-240.js?v=1.0.0-beta.255.0",
  "/content-cleanup-241.js?v=1.0.0-beta.255.0",
  "/app-runtime.js?v=1.0.0-beta.255.0",
  "/visual-v4.js?v=1.0.0-beta.255.0",
  "/mobile-layout.js?v=1.0.0-beta.255.0",
  "/social-v2.js?v=1.0.0-beta.255.0",
