const CACHE_NAME = "histodaily-rc30-year-xp-v1";
const APP_VERSION = "1.0.0-rc.30.0";
const CRITICAL_ASSETS = [
  "/",
  "/index.html",
  "/histodaily.css?v=1.0.0-rc.30.0",
  "/bundles/core-rc27.js?v=1.0.0-rc.30.0",
  "/bundles/content-rc27.js?v=1.0.0-rc.30.0",
  "/bundles/experience-rc27.js?v=1.0.0-rc.30.0",
