const CACHE_NAME = "histodaily-rc27-consolidated-v1";
const APP_VERSION = "1.0.0-rc.27.0";
const CRITICAL_ASSETS = [
  "/",
  "/index.html",
  "/histodaily.css?v=1.0.0-rc.27.0",
  "/bundles/core-rc27.js?v=1.0.0-rc.27.0",
  "/bundles/content-rc27.js?v=1.0.0-rc.27.0",
  "/bundles/experience-rc27.js?v=1.0.0-rc.27.0",
...
const OPTIONAL_ASSETS = [
  ...
  "/assets/hero-cinema.svg",
  "/assets/hero-economy.svg",
  "/assets/hero-english.webp",
  "/assets/hero-geography.svg",
  "/assets/hero-history-revolution.webp",
  "/assets/hero-history.webp",
  "/assets/hero-literature.svg",
  "/assets/hero-music.svg",
  "/assets/hero-philosophy.webp",
  "/assets/hero-science-inventions.svg",
